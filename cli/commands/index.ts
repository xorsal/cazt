...
// Helper to get global options from command hierarchy
function getGlobalOpts(command: Command): { json?: boolean; rpcUrl?: string; devnet?: boolean; testnet?: boolean; sandbox?: boolean; mainnet?: boolean } {
...
// Helper to resolve node URL from global options
function resolveNodeUrl(globalOpts: { rpcUrl?: string; sandbox?: boolean; devnet?: boolean; testnet?: boolean }): string {
...
function registerKeyCommands(program: Command): void {
